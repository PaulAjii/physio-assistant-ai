...
export const MedicalNoteSchema = z.object({
    ...
    subjective: z.object({
        presenting_complaint: z.string().describe("The complaint of the patient, why the patient has come to the clinic e.g., Pain in the lower back and inability to lift the left UL"),
        history_of_complaint: z.string().describe("History of Presenting Complaint. Use patient's verbatim words where possible."),
        ...
        relevant_medical_history: z.array(z.string()).describe("List relevant medical history (e.g., ypertension, peptic ulcer disease, diabetes mellitus"),
        drug_history: z.array(z.string()).describe("List of medications taken"),
        past_surgical_history: z.array(z.string()).describe("List of surgeries that have been carried out"),
        family_history: z.string().describe("Family history as described by the patient e.g., type of house, number of wives and children"),
        social_history: z.array(z.string()).describe("List of social activities and leisure activities e.g., smoking history, alcohol consumption, hobbies")
    }),
